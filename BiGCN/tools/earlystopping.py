    ...
    def __call__(self, val_loss, accs,F1,F2,F3,F4,model,modelname,str):
        ...
        if self.best_score is None:
            ...
            if self.counter >= self.patience:
                ...
                print("BEST Accuracy: {:.4f}|NR F1: {:.4f}|TR F1: {:.4f}|FR F1: {:.4f}|UR F1: {:.4f}"
...
class EarlyStopping3Class:
    ...
    def __call__(self, val_loss, accs,F1,F2,F3,model,modelname,str):
        ...
        if self.best_score is None:
            ...
            if self.counter >= self.patience:
                self.early_stop = True
                print("BEST Accuracy: {:.4f}|TR F1: {:.4f}|FR F1: {:.4f}|UR F1: {:.4f}"
                      .format(self.accs,self.F1,self.F2,self.F3))
        else:
            self.best_score = score
            self.accs = accs
            self.F1 = F1
