...
def format_rumor(data_dir, fold_num):
    print("Processing...SemEval17...rumor")
    ...
    rumor_dev_file = os.path.join(rumor_dir, "dev.json")
...
def main(arguments):
    ...
    parser.add_argument('--data_dir', help='directory to save data to', type=str, default='./rumor_data/semeval17/')
